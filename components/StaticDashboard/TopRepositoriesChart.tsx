...
export default function TopRepositoriesChart({
  ...
  const getDisplayCount = () => {
    ...
    if (isXlScreen) return 12; // XL+ screens can show more
    return 8; // Medium screens (tablets) show fewer to prevent overlap
  };
          ...
          <CardHeader className="flex items-center gap-2 space-y-0 border-b py-3 sm:py-4 sm:flex-row">
            <div className="grid flex-1 gap-1 text-center sm:text-left">
              ...
              <CardDescription className="text-sm">
                All {repositories.length} repositories ranked by commits
              </CardDescription>
            </div>
          </CardHeader>
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              {/* <Line
                ...
                strokeWidth={3}
                name="Commits"
                dot={{ fill: "var(--color-commits)", strokeWidth: 0, r: 0.1 }}
              /> */}
            </ComposedChart>
          </ResponsiveContainer>
        </ChartContainer>
